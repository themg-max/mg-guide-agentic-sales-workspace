> **HISTORICAL — Google All Things Agentic Hackathon judge guide.**
> This page is preserved competition-period evidence. It is **not** the
> current judge front door. If you are judging **The WebMCP Challenge**,
> start at [`../../JUDGE_START_HERE.md`](../../JUDGE_START_HERE.md) instead.
...
[`competition/NEW_WORK_LEDGER.md`](../NEW_WORK_LEDGER.md). Judges do
