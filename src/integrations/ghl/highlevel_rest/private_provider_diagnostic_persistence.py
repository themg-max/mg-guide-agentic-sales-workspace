"""Create-only private persistence for definitive provider error diagnostics."""
...
class PrivateProviderDiagnosticReceipt:
    """Verified receipt for one create-only diagnostic file."""
...
class PrivateProviderDiagnosticContext:
    """Execution identity and storage boundary for one provider diagnostic."""
